...
class HoistContainerReferences {
                ...
                if (this.entryFilePath) {
                    ...
                    for (const module of modules) {
                        if (module instanceof NormalModule &&
                            ...
                            const allRefs = this.getAllReferencedModules(compilation, module, 'initial');
    ...
    getAllReferencedModules(compilation, module, type) {
    ...
    hoistModulesInChunks(compilation, runtimeChunks, chunks, logger) {
        ...
        const allReferencedModules = this.getAllReferencedModules(compilation, runtimeModule, 'initial');
